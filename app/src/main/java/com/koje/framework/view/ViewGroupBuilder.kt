...
open class ViewGroupBuilder(override val view: ViewGroup) :
    ...
    fun addRecyclerView(action: RecyclerViewBuilder.() -> Unit) {
        val result = RecyclerView(view.context)
        view.addView(result)
        RecyclerViewBuilder(result).action()
    }
    ...
    fun addEditText(action: EditTextBuilder.() -> Unit) {
        val result = EditText(view.context)
        view.addView(result)
        EditTextBuilder(result).action()
    }
